...
exports.careerDatabase = void 0;
exports.getCareerById = getCareerById;
exports.getCareersByCategory = getCareersByCategory;
exports.getCategories = getCategories;
exports.careerDatabase = [
    // ── TECHNOLOGY ──────────────────────────────────────
    {
...
function getCareerById(id) {
    return exports.careerDatabase.find(c => c.id === id);
}
/**
 * Get careers by category
 */
function getCareersByCategory(category) {
    return exports.careerDatabase.filter(c => c.category.toLowerCase().includes(category.toLowerCase()));
}
/**
 * Get all unique categories
 */
function getCategories() {
    return Array.from(new Set(exports.careerDatabase.map(c => c.category)));
}
